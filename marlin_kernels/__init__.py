...
def machete_supported_schedules(
    ...
    return torch.ops._marlin_kernels.machete_supported_schedules(
        a_type,
        b_type.id,
        group_scales_type,
        group_zeros_type,
...
def machete_mm(
    ...
    return torch.ops._marlin_kernels.machete_mm(
        a,
        b_q,
        b_type.id,
        out_type,
...
def machete_prepack_B(
    ...
    return torch.ops._marlin_kernels.machete_prepack_B(
