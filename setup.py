...
envs = load_module_from_path("envs", os.path.join(ROOT_DIR, "envs.py"))
...
class cmake_build_ext(build_ext):
    ...
    def build_extensions(self) -> None:
        ...
        targets = []
        target_name = lambda s: remove_prefix(s, "marlin_kernels.")
...
def get_requirements() -> List[str]:
    ...
    if _no_device():
        ...
        for req in requirements:
            if "vllm-flash-attn" in req and not (
...
if _build_custom_ops():
    ext_modules.append(CMakeExtension(name="marlin_kernels._marlin_kernels"))
